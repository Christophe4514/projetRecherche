    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-4">
                        {!! Form::model($seminaire, [
                            'method' => 'PATCH',
                            'route' => ['seminaires.update', $seminaire->id],
                            ...
                            <div class="card-body">
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <div class="form-group">
                                        ...
                                        {{ Form::select('moderateur_id', $moderateurs, null, ['placeholder' => 'Selectionner un modérateur', 'class' => 'form-control select2']) }}
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <!-- /.col --> --}}
                    {{ Form::submit('Modifier le séminaire', ['class' => 'btn btn-success']) }}
                    {!! Form::close() !!}
                </div>
                <!-- /.row -->
            </div>
