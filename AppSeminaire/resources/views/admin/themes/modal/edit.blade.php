{!! Form::model($theme, [
    'method' => 'PATCH',
    'route' => ['themes.update', $theme->id],
    'enctype' => 'multipart/form-data',
]) !!}
@csrf
<div class="modal fade text-left" id="ModalEdit{{ $theme->id }}" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Modification de l'theme</h4>
