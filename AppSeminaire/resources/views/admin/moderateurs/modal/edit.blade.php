{!! Form::model($moderateur, [
    'method' => 'PATCH',
    'route' => ['moderateurs.update', $moderateur->id],
    'enctype' => 'multipart/form-data',
]) !!}
@csrf
<div class="modal fade text-left" id="ModalEdit{{ $moderateur->id }}" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Modification du moderateur</h4>
